...
Revision ID: b5c0aae2940d
Revises: 93d3970fd733
Create Date: 2023-06-19 16:25:43.381894
...
revision = 'b5c0aae2940d'
down_revision = '93d3970fd733'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('len_love_song', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
